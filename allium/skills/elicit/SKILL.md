...
- [Recognising library spec opportunities](/allium/skills/elicit/references/library-spec-signals.md) — signals, questions and decision framework for identifying library specs during elicitation
