...
ANALYSIS WINDOW:
- Primary window: 01:00 to 01:30 (log actions ONLY within this range)
- Context pre-roll: 00:50 to {primary_start} (use for context, do NOT log as new actions)
- Context post-roll: {primary_end} to 01:40 (use for context, do NOT log as new actions)
...
10. TOOL NAMING: For ui_context.active_tool, use standard terms (e.g., mouse_pointer, selection_tool, pen_tool, eraser_tool, hand_tool, text_tool, marquee_selection, lasso_selection, brush_tool, paint_bucket, eyedropper, zoom_tool, crop_tool, shape_tool) if they apply. If the active tool doesn't conceptually fit any standard term, create a custom lowercase descriptive name separated by underscores (e.g., 'bone_rig_tool').
